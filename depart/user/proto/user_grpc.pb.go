...
func (c *userServiceClient) UserInfo(ctx context.Context, in *ReqUserInfo, opts ...grpc.CallOption) (*RespUserInfo, error) {
	...
	err := c.cc.Invoke(ctx, "/fileStore.service.user.UserService/UserInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_UserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fileStore.service.user.UserService/UserInfo",
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fileStore.service.user.UserService",
	...
	Metadata: "depart/user/proto/user-file.proto",
}
